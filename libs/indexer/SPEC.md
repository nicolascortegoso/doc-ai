...
|---|---|---|
| `chunk` | `DocumentChunk` | The original chunk |
| `embedding` | `list[float]` | The embedding vector produced for this chunk |
...
The `Embedder` ABC provides:

| Method/Property | Signature | Description |
|---|---|---|
| `dimension` | `int` | Dimensionality of the produced embeddings |
...
1. `IndexedChunk` dataclass (added to `libs/common/models.py`)
...
- [ ] `IndexedChunk` dataclass defined in `libs/common/models.py` with: `chunk`, `embedding`
...
- [ ] `BatchIndexer` embedding dimension matches `Embedder.dimension`
